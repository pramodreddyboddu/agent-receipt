...
cannot push `.github/workflows/*`. v1.0.6 through v1.0.27 left
...
audit chain still exits 0 and deletes nothing), and a 1.0.27 `prove --html` smoke (`htmlPath`
written, PASS banner, no scripts or http(s) asset references).
The drop-in PR gate
